% main_zh.tex — 中文版论文
% 编译方式：xelatex main_zh.tex（至少编译两次）
% 作者：Y. X. Tan（陈勇勋）
\documentclass[UTF8,a4paper,zihao=-4]{ctexart}

\usepackage[top=2.8cm,bottom=3.0cm,left=3.0cm,right=2.6cm,headheight=14pt]{geometry}
...
\author{陈 勇 勋\thanks{通讯作者，E-mail：yxtan5022@gmail.com。}\\
\small 独立研究者，马来西亚}
\date{2026 年 8 月}
...
\centering
\footnotesize
\caption{开放生态规模效应的量化证据}
\label{tab:data}
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{1.6cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
维度 & 计算机开放生态 & 开源航天实践 \\
\midrule
协作规模 & GitHub 超 1 亿开发者、5.18 亿项目；2024 年贡献 52 亿次\cite{octoverse2024} & 全球已发射 CubeSat 2505 颗，88 国、600+ 组织参与\cite{kulu2024} \\
组件资产 & npm 约 487.5 万包、PyPI 约 63.5 万包；年请求约 6.689 万亿次\cite{sonatype2024} & NASA 公开数百个开源软件与代码仓库\cite{nasa} \\
迭代速度 & Linux 每约 10 周一大版本，每版约 1.5 万提交、2000 名开发者\cite{lwn2023} & CubeSat 第二千颗用时约 4 年（首个千颗约 16 年）\cite{kulu2024} \\
经济规模 & --- & 2023 年卫星产业收入约 2850 亿美元，占太空经济 71\%；在轨卫星 9691 颗（5 年 +361\%）\cite{sia2024} \\
\bottomrule
\end{tabularx}
\end{table}
...
\toprule
计算机发展史（借鉴原型） & 现代计算机对应技术 & 论文提出的"开源航天新形态" & 核心价值 \\
\midrule
开源社区协作 & Linux / Git / GitHub & OpenSpace 研发生态 & 打破垄断，降低研发门槛 \\
软硬件解耦 & POSIX / HAL 抽象层 & Space OS & 避免"一星一密"，跨硬件复用 \\
虚拟化与模拟 & QEMU / SITL / 游戏引擎 & 深空数字孪生与仿真 App & 无需物理硬件即可验证算法 \\
模块化服务 & Docker / 微服务 & 微服务化卫星/载荷架构 & 抗单点故障，模块可替换 \\
代码交付保障 & CI/CD 流水线 & DevSpaceOps 云端仿真验证 & 极端环境下自动化高可靠测试 \\
生态复用 & npm / PyPI 包管理器 & Space Package Registry & 避免重复造轮子，加速迭代 \\
开放商业闭环 & Red Hat / MySQL / Android & 开源底座 + 商业定制服务 & 解决资金来源与可持续性 \\
容错与信任 & BFT / 零信任架构 & 零信任深空计算网络 & 社区代码不危及核心安全 \\
\bottomrule
\end{tabularx}
\end{table}
